...
## t = -1.8369, df = 197.72, p-value = 0.06772
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.94222157  0.03341924
## sample estimates:
## mean of x mean of y 
## 0.9567282 1.4111293
```
...
## 
## data:  sample.a and sample.b
## t = -1.8369, df = 197.72, p-value = 0.9661
...
## 
## data:  sample.a and sample.b
## t = -1.8369, df = 197.72, p-value = 0.03386
...
## 
## data:  sample.a and sample.b
## t = -3.4256, df = 99, p-value = 0.0008944
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.7691152 -0.2049217
## sample estimates:
...
## 
## data:  sample.a and sample.b
## t = -1.9851, df = 197.53, p-value = 0.04852
## alternative hypothesis: true difference in means is not equal to 0
## 95 percent confidence interval:
##  -0.97083913 -0.00319774
## sample estimates:
## mean of x mean of y 
## 0.4170810 0.9040994
```
...
## 
## data:  sample.a and sample.b
## F = 2.0968, num df = 99, denom df = 99, p-value = 0.0002794
