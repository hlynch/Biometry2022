...
## -18.6822  -4.7487  -0.4395   4.4847  20.4275 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   0.6594     3.0385   0.217     0.83    
## X            -1.9719     0.1712 -11.521 3.87e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 8.114 on 28 degrees of freedom
## Multiple R-squared:  0.8258,	Adjusted R-squared:  0.8196 
## F-statistic: 132.7 on 1 and 28 DF,  p-value: 3.872e-12
```
...
## t1* 6.3002197  0.21703190  4.63641256
## t2* 0.6615263 -0.00621786  0.07603634
```
