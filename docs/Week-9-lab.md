...
## -16.029  -3.236   1.349   4.069  16.604 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   1.0956     2.8902   0.379    0.707    
## X            -2.0911     0.1628 -12.845 2.94e-13 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 7.718 on 28 degrees of freedom
## Multiple R-squared:  0.8549,	Adjusted R-squared:  0.8497 
## F-statistic:   165 on 1 and 28 DF,  p-value: 2.944e-13
```
...
## t1* 6.3002197  0.341570316  4.60464299
## t2* 0.6615263 -0.007521194  0.07475338
```
