...
## -26.214  -2.649   1.683   5.595  11.913 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)  -6.2575     3.1610   -1.98   0.0577 .  
## X            -1.9870     0.1781  -11.16 8.09e-12 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 8.441 on 28 degrees of freedom
## Multiple R-squared:  0.8164,	Adjusted R-squared:  0.8099 
## F-statistic: 124.5 on 1 and 28 DF,  p-value: 8.093e-12
```
...
## t1* 6.3002197  0.289423182  4.72123469
## t2* 0.6615263 -0.007057206  0.07774815
```
