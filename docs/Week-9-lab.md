...
## -17.9254  -4.9903   0.1129   6.1506  19.9454 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   -4.117      3.692  -1.115    0.274    
## X             -1.938      0.208  -9.321 4.44e-10 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 9.859 on 28 degrees of freedom
## Multiple R-squared:  0.7563,	Adjusted R-squared:  0.7476 
## F-statistic: 86.88 on 1 and 28 DF,  p-value: 4.44e-10
```
...
## t1* 6.3002197  0.290852092  4.59380463
## t2* 0.6615263 -0.005636078  0.07540575
```
