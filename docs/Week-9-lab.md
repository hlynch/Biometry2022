...
## -18.203  -8.499   2.243   7.365  19.882 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   0.3948     4.0736   0.097    0.923    
## X            -2.4860     0.2295 -10.834 1.59e-11 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 10.88 on 28 degrees of freedom
## Multiple R-squared:  0.8074,	Adjusted R-squared:  0.8005 
## F-statistic: 117.4 on 1 and 28 DF,  p-value: 1.595e-11
```
...
## t1* 6.3002197  0.174174244   4.5218605
## t2* 0.6615263 -0.005307373   0.0740259
```
