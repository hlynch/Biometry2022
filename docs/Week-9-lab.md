...
## -22.637  -6.879  -0.681   8.552  13.946 
## 
## Coefficients:
##             Estimate Std. Error t value Pr(>|t|)    
## (Intercept)   -5.671      3.782  -1.500    0.145    
## X             -2.122      0.213  -9.963 1.05e-10 ***
## ---
## Signif. codes:  0 '***' 0.001 '**' 0.01 '*' 0.05 '.' 0.1 ' ' 1
## 
## Residual standard error: 10.1 on 28 degrees of freedom
## Multiple R-squared:   0.78,	Adjusted R-squared:  0.7721 
## F-statistic: 99.26 on 1 and 28 DF,  p-value: 1.045e-10
```
...
## t1* 6.3002197  0.275529156  4.54760037
## t2* 0.6615263 -0.006869813  0.07403486
```
